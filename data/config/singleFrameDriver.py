...
import lsst.afw.display.rgb.rgbContinued
...
import lsst.afw.display.rgb.rgb
...
config.processCcd.charImage.measurement.plugins.names=['modelfit_CModel', 'ext_convolved_ConvolvedFlux', 'base_PixelFlags', 'modelfit_DoubleShapeletPsfApprox', 'ext_photometryKron_KronFlux', 'base_SdssCentroid', 'base_GaussianFlux', 'base_CircularApertureFlux', 'ext_shapeHSM_HsmShapeRegauss', 'ext_shapeHSM_HsmSourceMomentsRound', 'base_PsfFlux', 'base_Jacobian', 'base_SdssShape', 'base_FPPosition', 'ext_shapeHSM_HsmSourceMoments', 'ext_shapeHSM_HsmPsfMoments']
# whether to run this plugin in single-object mode
...
config.processCcd.charImage.measureApCorr.sourceSelector['science'].signalToNoise.errField='base_PsfFlux_fluxErr'
...
# Select objects with value less than this
config.processCcd.charImage.ref_match.matcher.sourceSelector['science'].unresolved.maximum=0.5
...
# Name of the source flux error field to use.
config.processCcd.charImage.ref_match.matcher.sourceSelector['science'].signalToNoise.errField='base_PsfFlux_fluxErr'
...
# Name of a flag field that is True for Sources that should be used.
config.processCcd.charImage.ref_match.matcher.sourceSelector['flagged'].field='calib_psf_used'
...
# Select objects with value less than this
config.processCcd.charImage.ref_match.sourceSelection.unresolved.maximum=0.5
...
# Name of the source flux error field to use.
config.processCcd.charImage.ref_match.sourceSelection.signalToNoise.errField='base_PsfFlux_fluxErr'
...
# Name of the source flux error field to use.
config.processCcd.charImage.measurePsf.starSelector['science'].signalToNoise.errField='base_PsfFlux_fluxErr'
...
import lsst.meas.algorithms.loadIndexedReferenceObjects
config.processCcd.calibrate.astromRefObjLoader.retarget(target=lsst.meas.algorithms.loadIndexedReferenceObjects.LoadIndexedReferenceObjectsTask, ConfigClass=lsst.meas.algorithms.loadIndexedReferenceObjects.LoadIndexedReferenceObjectsConfig)
...
# Mapping of camera filter name: reference catalog filter name; each reference filter must exist
config.processCcd.calibrate.astromRefObjLoader.filterMap={'B': 'g', 'V': 'r', 'R': 'r', 'I': 'i', 'r2': 'r', 'i2': 'i', 'N387': 'g', 'N468': 'g', 'N515': 'g', 'N527': 'g', 'N656': 'r', 'N718': 'i', 'N816': 'i', 'N921': 'z', 'N926': 'z', 'N973': 'y', 'N1010': 'y', 'I945': 'z'}

# Name of the ingested reference dataset
config.processCcd.calibrate.astromRefObjLoader.ref_dataset_name='ps1_pv3_3pi_20170110'

import lsst.meas.algorithms.loadIndexedReferenceObjects
config.processCcd.calibrate.photoRefObjLoader.retarget(target=lsst.meas.algorithms.loadIndexedReferenceObjects.LoadIndexedReferenceObjectsTask, ConfigClass=lsst.meas.algorithms.loadIndexedReferenceObjects.LoadIndexedReferenceObjectsConfig)
...
# Mapping of camera filter name: reference catalog filter name; each reference filter must exist
config.processCcd.calibrate.photoRefObjLoader.filterMap={'B': 'g', 'V': 'r', 'R': 'r', 'I': 'i', 'r2': 'r', 'i2': 'i', 'N387': 'g', 'N468': 'g', 'N515': 'g', 'N527': 'g', 'N656': 'r', 'N718': 'i', 'N816': 'i', 'N921': 'z', 'N926': 'z', 'N973': 'y', 'N1010': 'y', 'I945': 'z'}
...
# Select objects with value less than this
config.processCcd.calibrate.astrometry.matcher.sourceSelector['science'].unresolved.maximum=0.5
...
# Name of the source flux error field to use.
config.processCcd.calibrate.astrometry.matcher.sourceSelector['science'].signalToNoise.errField='base_PsfFlux_fluxErr'
...
# Name of a flag field that is True for Sources that should be used.
config.processCcd.calibrate.astrometry.matcher.sourceSelector['flagged'].field='calib_psf_used'
...
# Select objects with value less than this
config.processCcd.calibrate.astrometry.sourceSelection.unresolved.maximum=0.5
...
# Name of the source flux error field to use.
config.processCcd.calibrate.astrometry.sourceSelection.signalToNoise.errField='base_PsfFlux_fluxErr'
...
# Name of the source flux error field to use.
config.processCcd.calibrate.photoCal.match.sourceSelection.signalToNoise.errField='base_PsfFlux_fluxErr'
...
config.processCcd.calibrate.measurement.plugins.names=['base_LocalBackground', 'base_PixelFlags', 'ext_photometryKron_KronFlux', 'base_SdssCentroid', 'base_GaussianFlux', 'base_CircularApertureFlux', 'base_SkyCoord', 'base_Variance', 'ext_shapeHSM_HsmShapeRegauss', 'base_Blendedness', 'ext_shapeHSM_HsmSourceMomentsRound', 'base_NaiveCentroid', 'base_PsfFlux', 'base_Jacobian', 'base_SdssShape', 'base_FPPosition', 'ext_shapeHSM_HsmSourceMoments', 'ext_shapeHSM_HsmPsfMoments']
# whether to run this plugin in single-object mode
